...
<body>
    <div class="container">
        ...
        <form method="POST">
            <fieldset>
                <input type="text" name="first_name" value="<?php echo $firstName;?>" class="username" placeholder="Frist name" /><br/><br/>
                ...
                <input type="submit" name="submit" id="update" value="Update" /><br/>
